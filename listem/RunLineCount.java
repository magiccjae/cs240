...
public class RunLineCount {
	...
	public static void main(String[] args) {
		...
		/**
		 * Create an instance of your LineCounter here
		 */
		LineCounter lineobj = new LineCounterImpl();
		Map<File, Integer> lineCountResult = lineobj.countLines(new File(dirName), filePattern, recursive);
